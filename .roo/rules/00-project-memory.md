...
1. **Maintain `JOURNAL.md`**: All major architectural changes, key decisions, or workflow modifications must be logged in the `JOURNAL.md` file located in the `logs` directory. **Every new entry MUST be prepended to the top of the file (added at the beginning); do not append to the end.**
